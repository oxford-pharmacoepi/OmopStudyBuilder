...
- `study_code/`  
  - `study_code.Rproj`: open this in RStudio to work on the main analysis code. It sets the working directory so all relative paths behave correctly.  
...
- `diagnostics_code/`  
  - `diagnostics_code.Rproj`: open this project to work on diagnostics. It keeps diagnostics code separate from the main analysis project.  
