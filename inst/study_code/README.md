...
2)  Open the project <i>StudyCode.Rproj</i> from the study_code directory in RStudio (when inside the project, you will see its name on the top-right of your RStudio session)
