...
2)  Open the project <i>diagnostics.Rproj</i> from the diagnostics_code directory in RStudio (when inside the project, you will see its name on the top-right of your RStudio session)
