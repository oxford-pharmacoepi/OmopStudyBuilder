...
To distribute the study, share the **study folder** created by `initStudy()` (including `study_code/` and `renv.lock`). Partners can build and run using the same commands.
