...
``` r
initStudy(directory, diagnostics = TRUE, study = TRUE)
```
...
#> ✔ /tmp/RtmpPvA4Dm/SampleStudy prepared as root folder for study.
#> ✔ /tmp/RtmpPvA4Dm/SampleStudy/diagnostics_code prepared for study diagnostics code
#> ✔ /tmp/RtmpPvA4Dm/SampleStudy/diagnostics_shiny prepared for diagnostics shiny app
#> ✔ /tmp/RtmpPvA4Dm/SampleStudy/study_code prepared for study study code
#> ✔ /tmp/RtmpPvA4Dm/SampleStudy/study_shiny prepared for study shiny app
